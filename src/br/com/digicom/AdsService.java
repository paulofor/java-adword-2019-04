...
public abstract class AdsService {
	...
	protected HttpTransport setProxy() {
		...
		System.setProperty("https.proxyPassword", "Piquet07");
		...
		System.setProperty("http.proxyPassword", "Piquet07");
		...
		Authenticator.setDefault(new Authenticator() {
			...
			protected PasswordAuthentication getPasswordAuthentication() {
				...
				if (this.getRequestingHost().contains("10.21.7.10") && this.getRequestingPort() == 82
					...
					return new PasswordAuthentication("tr626987", "Piquet07".toCharArray());
				}
